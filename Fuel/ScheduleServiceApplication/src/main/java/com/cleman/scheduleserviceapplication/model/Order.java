...
//    public static final String SEQUENCE_NAME = "orders_Sequence";
    ...
    public Order(String orderReferenceId, String fuelStationName, String fuelStationNumber, int fuelTypeId, String fuelType, int fuelCapacity, LocalDate date, LocalDate dispatchDate, String orderStatus) {
